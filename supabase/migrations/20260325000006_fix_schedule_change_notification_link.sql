-- Fix: Đổi link_to trong notification của schedule_changed
-- từ '/schedule' (lịch của chính manager) → '/dashboard' (lịch toàn team)
-- Khi manager click vào notification, redirect sang /dashboard để thấy lịch của member vừa đổi

-- ================================================================
-- update_slot_with_reason — chỉ thay link_to
-- ================================================================
...
-- ================================================================
-- delete_slot_with_reason — chỉ thay link_to
-- ================================================================
